...
function OnlineBooking() {
    ...
    return (
        <section style={{width: 'min(90%, 1000px)', margin: '0 auto', textAlign: 'center'}}>
            <h2>Book online</h2>
            ...
            <iframe title="booking" id='cliniko-91023304' src='https://kibworth-osteopaths.uk1.cliniko.com/bookings?business_id=331656748404315481&embedded=true' frameborder='0' scrolling='auto' style={{pointerEvents: 'auto', display: 'block', width: '100%'}}></iframe>
        </section>
    )
}
